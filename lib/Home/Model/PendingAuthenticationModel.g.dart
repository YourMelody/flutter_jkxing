...
part of 'PendingAuthenticationModel.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PendingAuthenticationModel _$PendingAuthenticationModelFromJson(Map<String, dynamic> json) {
	return PendingAuthenticationModel(
		json['userId'] as int,
...
Map<String, dynamic> _$PendingAuthenticationModelToJson(PendingAuthenticationModel instance) =>
	<String, dynamic>{
