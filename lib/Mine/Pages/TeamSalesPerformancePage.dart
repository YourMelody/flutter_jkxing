			...
			child: Column(children: <Widget>[
				...
				Row(children: <Widget>[
					...
					Column(children: <Widget>[
						...
						Text(
							this.detailModel?.teamNum == null ? '--' : this.detailModel.teamNum.toString(),
					...
					Expanded(child: Column(children: <Widget>[
						...
						Padding(padding: EdgeInsets.only(bottom: 3)),
						Text(
							this.detailModel?.teamTargetMoney == null ? '--' : (this.detailModel.teamTargetMoney/100.0).toStringAsFixed(2),
							style: TextStyle(fontSize: 16, color: Color(0xff4d4d4d))
						)
					])),
		...
		return Container(
			...
			decoration: BoxDecoration(
				border: Border(
					...
					bottom: index == this.detailModel.agentList.length + 2 ? BorderSide(width: 0) : BorderSide(color: Color(0xff6bcbd6), width: 1),
					top: index == this.detailModel.agentList.length + 3 ? BorderSide(color: Color(0xff6bcbd6), width: 1) : BorderSide(width: 0)
				),
			...
			child: Row(children: <Widget>[
				...
				Expanded(child: Center(
					child: Text(
						agentModel.agentTargetMoney == null ? '--' :
				...
				Expanded(child: Center(
					child: Text(
						agentModel.agentBonusMoney == null ? '--' :
